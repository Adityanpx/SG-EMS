...
import {
  ...
  FileText, Megaphone, LogOut, Building2, Menu, X, ShieldCheck
} from 'lucide-react'
      ...
      >
        ...
        <div className="p-6 border-b border-white/5">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-rose-500 to-brand-600 flex items-center justify-center shadow-glow-purple">
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          {NAV.map(({ href, label, icon: Icon }) => {
            ...
            return (
              ...
              >
                <Icon className={`w-4 h-4 ${active ? 'text-rose-400' : 'text-slate-500 group-hover:text-slate-300'}`} />
                {label}
              </Link>
            )
          })}
        ...
        <div className="p-4 border-t border-white/5">
          <div className="flex items-center gap-3 px-3 py-2 mb-2">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-rose-500 to-brand-600 flex items-center justify-center text-xs font-bold text-white">

        ...
        <div className={`p-6 border-b ${isDark ? 'border-white/5' : 'border-gray-100'}`}>
          <div className="flex items-center gap-3">
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center shadow-lg ${
              isDark 
                ? 'bg-gradient-to-br from-rose-500 to-brand-600' 
            ...
            <div>
              ...
              <p className={`text-xs ${isDark ? 'text-rose-400' : 'text-indigo-600'}`}>Admin Portal</p>
            </div>
          </div>
        </div>
        ...
        <div className={`p-4 border-t ${isDark ? 'border-white/5' : 'border-gray-100'}`}>
          <div className={`flex items-center gap-3 px-3 py-3 mb-2 rounded-xl ${isDark ? 'bg-white/5' : 'bg-gray-50'}`}>
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className={`text-xs ${isDark ? 'text-rose-400' : 'text-indigo-600'}`}>Administrator</p>
            </div>
          </div>
          <button
            onClick={signOut}
